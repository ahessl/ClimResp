...
```{r read pdsi climate}
pdsi_file <- "pdsi_wv_div4.csv"
clim.path <- paste0("data/climate_data/pdsi/", pdsi_file)
...
```{r id_events}
  ...
  event_len <- as.numeric(rep(rns$lengths, rns$lengths))
